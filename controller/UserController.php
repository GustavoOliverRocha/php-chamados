...
{ 
	...
	static function teste2(){
		echo "NAMESPACE DO NAMESPACE";
	}

	public function home($teste){
		//(new DocumentoController)->home(4);
		//dd($teste);
		//(new Usuario)->home(44);//Ele não vai achar a classe pq ela ta em um subdir
	}
